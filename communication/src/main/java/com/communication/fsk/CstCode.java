...
public interface CstCode {
	...
	public final int AUDIOTRACK_STREAM_TYPE = AudioManager.STREAM_SYSTEM;
	// audio track mode
	...
	public final int AUDIOTRACK_CONFIG = AudioFormat.CHANNEL_IN_STEREO;
	...
	public final int AUDIORECORD_CONFIG = AudioFormat.CHANNEL_IN_MONO;
